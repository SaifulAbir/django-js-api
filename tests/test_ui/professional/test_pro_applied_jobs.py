...
class TestProfessionalAppliedJobs(unittest.TestCase):
    ...
    def test__company_detail_from__professional_applied_jobs__showing_data__should_pss(self):
        driver = self.driver
        COMPANY_URL = f'{MAIN_URL_HOME}/company-details/Company%20Example%20View'
        COMPANY_NAME = 'Company Example View'
        JOB_APPLIED_LIST_URL = f'{MAIN_URL_HOME}/professional/applied-jobs/'
        job_list = job_list_with_signin_helper(driver, JOB_APPLIED_LIST_URL)
